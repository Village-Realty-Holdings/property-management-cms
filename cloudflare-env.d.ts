/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: e85d14022379a92bcbd12f235399005d)
// Runtime types generated with workerd@1.20260907.1 2025-08-15 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_CloudflareEnv {
	R2: R2Bucket;
	D1: D1Database;
	IMAGES: ImagesBinding;
	ASSETS: Fetcher;
	DEFAULT_TENANT: "warren-beach";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DEFAULT_TENANT" | "PAYLOAD_SECRET" | "NEXT_PUBLIC_SERVER_URL" | "CRON_SECRET" | "PREVIEW_SECRET">> {}
}
