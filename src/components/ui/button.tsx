  ...
  "group/button inline-flex shrink-0 items-center justify-center rounded-lg border border-transparent bg-clip-padding text-sm font-medium whitespace-nowrap transition-colors outline-none select-none focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/40 active:not-aria-[haspopup]:translate-y-px disabled:pointer-events-none disabled:opacity-50 aria-invalid:border-destructive aria-invalid:ring-3 aria-invalid:ring-destructive/20 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
  {
    variants: {
      variant: {
        ...
        // Solid light button for use on photos and primary-coloured bands.
        inverse: "bg-background text-foreground hover:bg-background/90",
        // Outlined light button for the same surfaces.
        "inverse-outline":
          "border-current bg-transparent text-inherit hover:bg-background/15 aria-expanded:bg-background/15",
      },
      size: {
        ...
        "icon-lg": "size-12",
        // No box, for links rendered through CMSLink.
